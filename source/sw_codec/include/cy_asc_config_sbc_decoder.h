...
/**
 * @file cy_asc_config_sbc_decoder.h
 *
 ...
 */
#ifndef __CY_ASC_CONFIG_SBC_DECODER_H__
#define __CY_ASC_CONFIG_SBC_DECODER_H__
...
/**
 * SBC decoder additional config structure
 */
typedef struct
{
    /**
    ...
    /**
     * UUID to be used. Need for SBC Wideband
...
}cy_asc_sbc_decode_stream_info_t;

#ifdef __cplusplus
}
#endif
#endif // __CY_ASC_CONFIG_SBC_DECODER_H__
