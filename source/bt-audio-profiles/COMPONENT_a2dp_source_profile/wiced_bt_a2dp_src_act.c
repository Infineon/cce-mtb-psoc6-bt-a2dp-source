        ...
        wiced_bt_a2dp_source_data_t *p_data)
{
   ...
   /*A2DP TEST Why do we need reconnect here ? */
    ...
    if (p_scb->recfg_ind)
    {
        WICED_BTA2DP_SRC_TRACE("Calling wiced_bt_avdt_start_req, Second Start... \r\n");
        ...
        wiced_bt_a2dp_source_data_t *p_data)
{
    ...
    if (p_scb->started == WICED_FALSE)
    {
        ...
        {
            WICED_BTA2DP_SRC_TRACE("Start request is sent [wiced_bt_avdt_start_req] !! \r\n");
            wiced_bt_avdt_start_req(&p_scb->avdt_handle, 1);
        }
    }
    else
    {
        WICED_BTA2DP_SRC_TRACE("Start ok request [wiced_bt_a2dp_source_start_ok] !! \r\n ");
